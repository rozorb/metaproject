          ...
          <ul class="reviews">
            <li>
              ...
              <div class="img-name-container">
                <img src={person1} class="rev-img" alt="person-1" />
                <h4>Carla</h4>
              </div>
            ...
            <li>
              ...
              <div class="img-name-container">
                <img src={person2} class="rev-img" alt="person-2" />
                <h4>Steve</h4>
              </div>
            ...
            <li>
              <h4 class="rating">4.4/5</h4>
              <div class="img-name-container">
                <img src={person3} class="rev-img" alt="person-3" />
                <h4>Kaya</h4>
              </div>
            ...
            <li>
              <h4 class="rating">4.6/5</h4>
              <div class="img-name-container">
                <img src={person4} class="rev-img" alt="person-4" />
                <h4>Ben</h4>
              </div>
